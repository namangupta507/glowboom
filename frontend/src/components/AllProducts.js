...
export const AllProducts = () => {
    ...
    const handleEditSubmit = async (e) => {
        ...
        try {
            const res = await axios.put(`https://glowboom.onrender.com/products/editProduct/${currentProduct._id}`, formData, {
                headers: {
    ...
    const handleDelete = async (id) => {
        try {
            await axios.delete(`https://glowboom.onrender.com/products/deleteProduct/${id}`);
                        ...
                        <div className="col-md-3 mb-5" key={product._id}>
                            <div className="products-block">
                                {product?.images?.map((image, index) => (
                                    ...
                                    <img key={index} className='product_image' src={`https://glowboom.onrender.com/${image}`} alt="product_image" />
                                    </div>
                                ))}
